...
```hcl
github.com/pbs/terraform-aws-elasticache-serverless-redis-and-memcached-module?ref=0.0.2
```
...
module "elasticache-serverless-redis-and-memcached" {
  source = "github.com/pbs/terraform-aws-elasticache-serverless-redis-and-memcached-module?ref=0.0.2"
